...
(() => {
  ...
  const PROJECTS = {
    portfolio: {
      ...
      status: "● Public repo · 4 Ağu 2026 güncellendi",
    },
    profile: {
      category: "profile",
