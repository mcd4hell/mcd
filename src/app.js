...
(() => {
  ...
  const PROJECTS = {
    portfolio: {
      ...
      status: "● Public repo · 3 Ağu 2026 güncellendi",
    },
    profile: {
      category: "profile",
