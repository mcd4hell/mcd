...
(() => {
  ...
  const PROJECTS = {
    portfolio: {
      ...
      status: "● Public repo · 20 Eyl 2026 güncellendi",
    },
    profile: {
      category: "profile",
