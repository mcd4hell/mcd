(() => {
  ...
  const PROJECTS = {
    portfolio: {
      ...
      status: "● Public repo · 16 Eyl 2026 güncellendi",
    },
    profile: {
      category: "profile",
